...
request
  ...
  .on('finish', () => {
    ...
    const destSvgFolder = join(
      __dirname,
      '../../../libs/bee-q/src/components/my-component/svg/'
    );
    ...
    try {
      ...
      console.error(
        '❌ Something went wrong while extracting and moving the SVG files:',
        error
      );
    } finally {
      console.log(
        '✅ Phosphor-icon library have been extracted successfully!! 🎉 '
      );
    }
  });
